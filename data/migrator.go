...
const (
	// Update the migration content in the database
	ActionUpdate = Action(iota)
	// Ignores a new migration file that has yet to be run
	ActionIgnore
	// Remove the migration entry from the database
	ActionPrune
	...
	// Runs the migration
	ActionMigrate
	// Rollbacks the most recent migration
	ActionRollback
)
